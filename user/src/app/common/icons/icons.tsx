 ...
 export const FacebookIcon = ({ style }: IIcon) => {
    return (
...
export const TwitterIcon = ({ style }: IIcon) => {
    return (
...
export const InstaIcon = ({ style }: IIcon) => {
    return (
...
export const MapIcon = ({ style }: IIcon) => {
    return (
...
export const ClipIcon = ({ style }: IIcon) => {
    return (
